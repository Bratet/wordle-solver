#!/usr/bin/env python3
"""
Wordle Solver Strategy Analysis
------------------------------
This script evaluates the performance of a Wordle solving strategy
...
def analyze_strategy_performance(game: Wordle, strategy: Any, target_words: List[str]) -> Dict[str, Any]:
    """
    Analyze the strategy's performance against all target words.
    ...
    print(f"Analyzing strategy performance against {len(target_words)} target words...")
...
def generate_performance_plots(results: Dict[str, Any], output_dir: str = "output") -> None:
    """
...
def save_performance_report(results: Dict[str, Any], output_dir: str = "output") -> str:
    """
...
def main():
    ...
    for strategy_name, strategy in strategies.items():
        ...
        results = analyze_strategy_performance(game, strategy, target_words)
        
        # Generate individual plots and save report
        generate_performance_plots(results, strategy_output_dir)
        report_path = save_performance_report(results, strategy_output_dir)
        
        print(f"Analysis of {strategy_name} completed successfully.")
        print(f"Performance report saved to {report_path}")
